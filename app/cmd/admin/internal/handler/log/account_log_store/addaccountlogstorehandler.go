...
func AddAccountLogStoreHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddAccountLogStoreReq
		...
		l := account_log_store.NewAddAccountLogStoreLogic(r.Context(), svcCtx)
		err := l.AddAccountLogStore(&req)
		if err != nil {
			httpx.Error(w, err)
			return
		}
