...
import (
	...
	"gozore-mall/app/cmd/admin/internal/logic/log/account_log_store"
...
func GetAccountLogStorePageHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AccountLogStorePageReq
		...
		l := account_log_store.NewGetAccountLogStorePageLogic(r.Context(), svcCtx)
		resp, err := l.GetAccountLogStorePage(&req)
		if err != nil {
			httpx.Error(w, err)
			return
		}
