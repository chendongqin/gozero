...
import (
	...
	"gozore-mall/app/cmd/admin/internal/logic/sys/config"
...
func GetWebInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.WebInfoReq
		...
		l := config.NewGetWebInfoLogic(r.Context(), svcCtx)
		resp, err := l.GetWebInfo(&req)
		if err != nil {
			httpx.Error(w, err)
			return
		}
