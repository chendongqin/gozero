...
func DeleteStorePermMenuHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeleteStorePermMenuReq
		...
		l := storemenu.NewDeleteStorePermMenuLogic(r.Context(), svcCtx)
		err := l.DeleteStorePermMenu(&req)
		if err != nil {
			httpx.Error(w, err)
			return
		}
