...
func AddStorePermMenuHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddStorePermMenuReq
		...
		l := storemenu.NewAddStorePermMenuLogic(r.Context(), svcCtx)
		err := l.AddStorePermMenu(&req)
		if err != nil {
			httpx.Error(w, err)
			return
		}
