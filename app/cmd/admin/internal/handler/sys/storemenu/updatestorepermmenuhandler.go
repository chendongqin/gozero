...
func UpdateStorePermMenuHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateStorePermMenuReq
		...
		l := storemenu.NewUpdateStorePermMenuLogic(r.Context(), svcCtx)
		err := l.UpdateStorePermMenu(&req)
		if err != nil {
			httpx.Error(w, err)
			return
		}
